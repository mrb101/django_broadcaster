...
from django_broadcaster.apps import DjangoDispatchConfig
...
class TestDjangoDispatchConfig:
    ...
    def test_app_config_attributes(self):
        ...
        mock_module = types.ModuleType("django_broadcaster")
        mock_module.__path__ = ["path/to/django_broadcaster"]

        app_config = DjangoDispatchConfig("django_broadcaster", mock_module)

        assert app_config.name == "django_broadcaster"
    ...
    def test_ready_imports_signals(self):
        ...
        with patch("django_broadcaster.signals") as mock_signals:
